...
def test():
    ...
    assert sorted(np.unique(pqc.flags['TEMP']['morello2014'])) == [0, 1, 2, 3]
    assert sorted(np.unique(pqc.flags['TEMP2']['morello2014'])) == [1, 2]
    assert sorted(np.unique(pqc.flags['PSAL']['morello2014'])) == [0, 1, 2, 3]
    assert sorted(np.unique(pqc.flags['PSAL2']['morello2014'])) == [1, 2]
